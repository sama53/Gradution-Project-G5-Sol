...
namespace Gradution_Project_G5.BLL.Interfaces
{
    public interface IUserServices
    {
        ...
        Task<Result<PagedResult<UserVM>>> GetUsersByRoleAsync(string role, int page = 1, int pageSize = 10);
        Task<Result<PagedResult<UserVM>>> SearchUsersAsync(string searchTerm, int page = 1, int pageSize = 10);
