...
namespace Gradution_Project_G5.BLL.Interfaces
{
    public interface ICourseServices
    {
        ...
        Task<Result<PagedResult<CourseVM>>> GetAllCoursesAsync(int page = 1, int pageSize = 5);
        Task<Result<PagedResult<CourseVM>>> SearchCoursesAsync(string searchTerm, int page = 1, int pageSize = 5);
