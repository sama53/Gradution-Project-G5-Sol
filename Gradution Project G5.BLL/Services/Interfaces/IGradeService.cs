...
namespace Gradution_Project_G5.BLL.Interfaces
{
    public interface IGradeServices
    {
        ...
        Task<Result<PagedResult<GradeVM>>> GetAllGradesAsync(int page = 1, int pageSize = 10);
        Task<Result<PagedResult<GradeVM>>> GetGradesBySessionAsync(int sessionId, int page = 1, int pageSize = 10);
        Task<Result<PagedResult<GradeVM>>> GetGradesByTraineeAsync(int traineeId, int page = 1, int pageSize = 10);
